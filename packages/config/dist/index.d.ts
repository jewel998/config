...
export type { ConfigDefinition, ConfigResolveContext, ConfigVersionRecord, EnvironmentRecord, ProjectRecord, TenantRecord, } from "./types";
...
export declare const createConfigClient: (options: ConfigClientOptions) => ConfigClient;
